...
| 벤치 | KoPII-Lite (fp32) | KoPII-Lite INT8 | BCCard MoAI-PF-INT8 (1.4B) |
|---|---:|---:|---:|
...
```python
from kopii import KoPii            # serve/kopii.py — ONNX + Viterbi + 후처리 포함
det = KoPii("model.int8.onnx", tokenizer_dir=".")
